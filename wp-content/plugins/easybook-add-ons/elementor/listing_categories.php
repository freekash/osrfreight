...
class CTH_Listing_Categories extends Widget_Base {
    ...
    */
    ...
    public function get_title() {
        return __( 'Listing Categories', 'easybook-add-ons' );
    }
    ...
    */
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'section_query',
            [
                'label' => __( 'Categories Query', 'easybook-add-ons' ),
            ]
        );
        ...
        $this->add_control(
            'cat_ids',
            [
                'label' => __( 'Select Categories to include (Leave empty for ALL)', 'easybook-add-ons' ),
        ...
        $this->add_control(
            'cat_ids_not',
            [
                'label' => __( 'Or Categories to exclude (Leave empty for ALL)', 'easybook-add-ons' ),
                'type' => Controls_Manager::SELECT2,
                'options' => easybook_addons_get_listing_categories_select2(),
                'multiple' => true,
                'label_block' => true,
        ...
        $this->add_control(
            'number',
            [
                'label' => __( 'Number of Categories to show', 'easybook-add-ons' ),
        ...
        $this->start_controls_section(
            'section_layout',
            [
                'label' => __( 'Categories Layout', 'easybook-add-ons' ),
            ]
        );
        ...
        $this->add_control(
            'items_width',
            [
                'label' => __( 'Categories Items Width', 'easybook-add-ons' ),
    ...
    protected function render( ) {
        ...
        if ( ! empty( $listing_terms ) && ! is_wp_error( $listing_terms ) ){
            ...
            <?php
                ...
                if($url != '') echo '<div class="view-all-cats"><a href="' . $url . '" ' . $target .' class="btn big-btn circle-btn dec-btn color-bg flat-btn">'.__('View All','easybook-add-ons').'<i class="fa fa-eye"></i></a></div>';
            ?>
        <?php
        }
