...
class CTH_Button_Add_Listing extends Widget_Base {
    ...
    */
    ...
    public function get_title() {
        return __( 'Button Add Listing', 'easybook-add-ons' );
    }
        ...
        $css_class = preg_replace( '/\s+/', ' ', implode( ' ', array_filter( $css_classes ) ) );
         ?> 
            ...
            <?php if(is_user_logged_in()) : ?>
                <a href="<?php echo get_the_permalink(easybook_addons_get_option('submit_page')).'#/addListing';?>" class="<?php echo esc_attr($css_class );?>">
            <?php else : ?>
                <a class="logreg-modal-open <?php echo esc_attr($css_class );?>" href="#" data-message="<?php esc_attr_e( 'You must be logged in to add listing.', 'easybook-add-ons' ); ?>">
            <?php endif; ?>
