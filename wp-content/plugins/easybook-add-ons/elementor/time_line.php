...
class CTH_Time_Line extends Widget_Base {
    ...
    */
    ...
    public function get_title() {
        return __( 'Time Line', 'easybook-add-ons' );
    }
    ...
    */
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'section_images',
            [
                'label' => __( 'Time Line', 'easybook-add-ons' ),
            ]
        );
        ...
        $this->add_control(
            'time_lines',
            [
                'label' => __( 'Time Line Items', 'easybook-add-ons' ),
                ...
                'default' => [
                    [
                        ...
                        'image' => array(
                            'id'=> 2144,
                            'url'=> 'http://localhost:8888/easybook/wp-content/uploads/2018/03/15.jpg'
                        ),
                        'video' => ''
                    ],
                    [
                        ...
                        'image' => array(
                            'id'=> 2145,
                            'url'=>'http://localhost:8888/easybook/wp-content/uploads/2018/03/16-1.jpg'
                        ),
                        'video' => ''
                    ],
                    [
                        ...
                        'image' => array(
                            'id'=> 2146,
                            'url'=>'http://localhost:8888/easybook/wp-content/uploads/2018/03/18.jpg'
                        ),
                        'video' => ''
                    ],
                ],
                'fields' => [
                    ...
                    [
                        'name' => 'step_num',
                        'label' => __( 'Step Number', 'easybook-add-ons' ),
                        'type' => Controls_Manager::TEXT,
                        'default' => '01 . ',
                        // 'label_block' => true,
                    ],
                    ...
                    [
                        ...
                        'default' => 'fa fa-map-o',
                        'label_block' => true,
                        // 'options'       => easybook_addons_fa5_icons()
                    ],
                    [
                        'name' => 'content',
                    ...
                    [
                        'name' => 'video',
                        'label' => __( 'Or Video URL', 'easybook-add-ons' ),
                        'type' => Controls_Manager::TEXT,
                        'placeholder' => __( 'https://www.youtube.com/watch?v=xpVfcZ0ZcFM', 'easybook-add-ons' ),
                        'label_block' => true,
                    ],
                ],
                'title_field' => '{{{ title }}}',
        ...
        $this->add_control(
            'first_side',
            [
                'label'       => __( 'First Content Side', 'easybook-add-ons' ),
        ...
        $this->add_control(
            'end_icon',
            [
                'label' => __( 'End Icon', 'easybook-add-ons' ),
                'type' => Controls_Manager::ICON,
                'default'=>'fa fa-check'
            ]
        );
