 ...
 * @see WP_Widget
 */
class EasyBook_Banner extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array('classname' => 'easybook_banner', 'description' => __( "EasyBook banner widget",'easybook-add-ons') );
		// Add Widget scripts
   		add_action('admin_enqueue_scripts', array($this, 'scripts'));
 
		parent::__construct('easybook-banner', __('EasyBook Banner','easybook-add-ons'), $widget_ops);
		$this->alt_option_name = 'easybook_banner';
	}
