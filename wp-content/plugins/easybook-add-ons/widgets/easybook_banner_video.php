 ...
 * @see WP_Widget
 */
class EasyBook_Banner_Video extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array('classname' => 'easybook_banner_video', 'description' => __( "EasyBook Popup Video widget",'easybook-add-ons') );
		// Add Widget scripts
   		add_action('admin_enqueue_scripts', array($this, 'scripts'));
 
		parent::__construct('easybook-banner-video', __('EasyBook Popup Video','easybook-add-ons'), $widget_ops);
		$this->alt_option_name = 'easybook_banner_video';
	}
		...
		<?php if ( $title ) {
			...
			<div class="sb-widge video-widget  fl-wrap">
                <?php if(!empty($banner_img)) :?>
                	<img src="<?php echo esc_url($banner_img); ?>"  class="respimg" alt="<?php _e( "banner image",'easybook-add-ons');?>"> 
                <?php endif;?>
...
?>
		...
		<p>
      	...
      	<button class="easybook_author_upload_image_button button button-primary"><?php _e('Upload Image','easybook-add-ons');?></button>
   		...
   		<p><label for="<?php echo $this->get_field_id( 'banner_link' ); ?>"><?php _e( 'Popup Video Link' ,'easybook-add-ons'); ?></label>
