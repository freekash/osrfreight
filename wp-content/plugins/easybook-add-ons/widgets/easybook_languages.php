 ...
 * @see WP_Widget
 */
class EasyBook_Languages extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array('classname' => 'easybook_languages', 'description' => __( "EasyBook languages widget",'easybook-add-ons') );
		// Add Widget scripts
   		add_action('admin_enqueue_scripts', array($this, 'scripts'));
 
		parent::__construct('easybook-languages', __('EasyBook Languages','easybook-add-ons'), $widget_ops);
		$this->alt_option_name = 'easybook_languages';
	}
	...
	public function widget( $args, $instance ) {
		...
		$title = ( ! empty( $instance['title'] ) ) ? $instance['title'] : __( 'Banner widget' ,'easybook-add-ons');
...
<!-- 
			...
			<div class="lang-wrap">
			    <div class="show-lang"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lan/1.png" alt=""> <span>Eng</span><i class="fa fa-caret-down"></i></div>
			    <ul class="lang-tooltip green-bg">
			        <li><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lan/4.png" alt=""> De</a></li>
			        <li><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lan/5.png" alt=""> It</a></li>
			        <li><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lan/2.png" alt=""> Fr</a></li>
			        <li><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lan/3.png" alt=""> Es</a></li>
			    </ul>
			</div>
...
?>
		...
		<p>
      	<label for="<?php echo $this->get_field_id( 'banner_img' ); ?>"><?php _e( 'Photo:','easybook-add-ons' ); ?></label>
      	...
      	<button class="easybook_author_upload_image_button button button-primary"><?php _e('Upload Image','easybook-add-ons');?></button>
   		...
   		<p><label for="<?php echo $this->get_field_id( 'banner_link' ); ?>"><?php _e( 'Link:' ,'easybook-add-ons'); ?></label>
