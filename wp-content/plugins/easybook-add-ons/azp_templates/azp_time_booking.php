...
<div class="<?php echo $classes; ?> authplan-hide-<?php echo $hide_widget_on_check;?>" <?php echo $el_id;?>>
	...
	<div class="box-widget-item fl-wrap" id="widget-tpicker-booking">
	    <?php if($wid_title != ''): ?>
	    <div class="box-widget-item-header">
	        <h3><?php echo $wid_title; ?></h3>
	    </div>
		<?php endif; ?>
	    <div class="tpicker-booking-inner">
	        <form method="POST" name="esb-tpicker-booking"> 
	        	...
	        	<input type="hidden" name="booking_type" value="tpicker">
