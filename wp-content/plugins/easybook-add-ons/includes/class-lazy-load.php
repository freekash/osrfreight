...
class Esb_Class_Lazy_Load{ 
    ...
    public static function enqueue_scripts(){
        ...
        wp_enqueue_script( 'lazyload', self::$plugin_url ."assets/js/lazyload.js?render=explicit#cthasync" , array('easybook-addons'), null , true );
    ...
    public static function lazyload_image_attributes($attrs){
        ...
        $lazy_placeholder = easybook_addons_get_option('lazy_placeholder');
