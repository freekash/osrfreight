...
class ActionScheduler_wpPostStore_PostStatusRegistrar {
	...
	protected function post_status_failed_labels() {
		$labels = array(
			'label'       => _x( 'Failed', 'post' , 'easybook-add-ons'),
			'label_count' => _n_noop( 'Failed <span class="count">(%s)</span>', 'Failed <span class="count">(%s)</span>', 'easybook-add-ons' ),
		);
	...
	protected function post_status_running_labels() {
		$labels = array(
			'label'       => _x( 'In-Progress', 'post', 'easybook-add-ons'),
			'label_count' => _n_noop( 'In-Progress <span class="count">(%s)</span>', 'In-Progress <span class="count">(%s)</span>', 'easybook-add-ons' ),
		);
