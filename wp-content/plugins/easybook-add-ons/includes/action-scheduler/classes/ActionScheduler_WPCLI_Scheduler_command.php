	...
	protected function print_total_actions( $total ) {
		WP_CLI::log(
			sprintf(
				...
				_n( 'Found %d scheduled task', 'Found %d scheduled tasks', $total, 'easybook-add-ons' ),
	...
	protected function print_total_batches( $batches_completed ) {
		WP_CLI::log(
			sprintf(
				...
				_n( '%d batch executed.', '%d batches executed.', $batches_completed, 'easybook-add-ons' ),
	...
	protected function print_error( Exception $e ) {
		WP_CLI::error(
			sprintf(
				...
				__( 'There was an error running the action scheduler: %s', 'easybook-add-ons' ),
				$e->getMessage()
			)
		);
	}
	...
	protected function print_success( $actions_completed ) {
		WP_CLI::success(
			sprintf(
				...
				_n( '%d scheduled task completed.', '%d scheduled tasks completed.', $actions_completed, 'easybook-add-ons' ),
