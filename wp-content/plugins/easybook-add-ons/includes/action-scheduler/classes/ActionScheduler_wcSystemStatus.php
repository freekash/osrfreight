...
class ActionScheduler_wcSystemStatus {
	...
	protected function get_template( $status_labels, $action_counts, $oldest_and_newest ) {
		...
		<table class="wc_status_table widefat" cellspacing="0">
			<thead>
				<tr>
					<th colspan="5" data-export-label="Action Scheduler"><h2><?php esc_html_e( 'Action Scheduler', 'easybook-add-ons' ); ?><?php echo wc_help_tip( esc_html__( 'This section shows scheduled action counts.', 'easybook-add-ons' ) ); ?></h2></th>
				</tr>
				<tr>
					<td><strong><?php esc_html_e( 'Action Status', 'easybook-add-ons' ); ?></strong></td>
					<td class="help">&nbsp;</td>
					<td><strong><?php esc_html_e( 'Count', 'easybook-add-ons' ); ?></strong></td>
					<td><strong><?php esc_html_e( 'Oldest Scheduled Date', 'easybook-add-ons' ); ?></strong></td>
					<td><strong><?php esc_html_e( 'Newest Scheduled Date', 'easybook-add-ons' ); ?></strong></td>
				</tr>
			</thead>
			<tbody>
				<?php
