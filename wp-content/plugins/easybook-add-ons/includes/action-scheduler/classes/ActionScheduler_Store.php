...
abstract class ActionScheduler_Store {
	...
	public function get_status_labels() {
		return array(
			self::STATUS_COMPLETE => __( 'Complete', 'easybook-add-ons' ),
			self::STATUS_PENDING  => __( 'Pending', 'easybook-add-ons' ),
			self::STATUS_RUNNING  => __( 'In-progress', 'easybook-add-ons' ),
			self::STATUS_FAILED   => __( 'Failed', 'easybook-add-ons' ),
			self::STATUS_CANCELED => __( 'Canceled', 'easybook-add-ons' ),
		);
	}
