...
*/
	...
	function locate($ip = null) {
		...
		$this->formatted_address = $this->result = implode( __( ', ', 'easybook-add-ons' ), array_filter(array($this->administrative_area_level_2,$this->administrative_area_level_1,$this->country)) );
	}
