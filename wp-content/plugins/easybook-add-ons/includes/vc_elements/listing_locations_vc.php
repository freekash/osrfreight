...
vc_map( array(
    "name"                      => esc_html__("Listing Locations", 'easybook-add-ons'),
    "description"               => esc_html__("Listing Locations",'easybook-add-ons'),
    "base"                      => "listing_locations_vc",
    ...
    "params"                    => array(
        array(
            "type"        => "textfield",
            "heading"     => __("Select Locations to include (Leave empty for ALL)", 'easybook-add-ons'),
            "param_name"  => "cat_ids",
            "admin_label" => true,
            "value"       => '',
        ),
        array(
            "type"        => "textfield",
            "heading"     => __("Or Locations to exclude (Leave empty for ALL)", 'easybook-add-ons'),
        ...
        array(
            "type"          => "textfield",
            "admin_label"   => true,
            "heading"       => esc_html__("Locations Items Width", 'easybook-add-ons'),
...
if ( class_exists( 'WPBakeryShortCode' ) ) {
    class WPBakeryShortCode_Listing_Locations_Vc extends WPBakeryShortCode {}
}