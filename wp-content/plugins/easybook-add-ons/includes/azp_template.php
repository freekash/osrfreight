...
class Azp_Template_Manager{
	...
	public static function register_post_type(){
		$labels = array( 
	        'name' => __( 'AZP Template', 'easybook-add-ons' ),
	        'singular_name' => __( 'AZP Template', 'easybook-add-ons' ),
	        'add_new' => __( 'Add Template', 'easybook-add-ons' ),
	        'add_new_item' => __( 'Add Template', 'easybook-add-ons' ),   
	        'edit_item' => __( 'Edit Template', 'easybook-add-ons' ),
	        'new_item' => __( 'New Template', 'easybook-add-ons' ),
	        'view_item' => __( 'View Template', 'easybook-add-ons' ),
	        'search_items' => __( 'Search Templates', 'easybook-add-ons' ),
	        'not_found' => __( 'No Templates found', 'easybook-add-ons' ),
	        'not_found_in_trash' => __( 'No Templates found in Trash', 'easybook-add-ons' ),
	        'parent_item_colon' => __( 'Parent Template:', 'easybook-add-ons' ), 
	        'menu_name' => __( 'AZP Template', 'easybook-add-ons' ),
	    );
	    ...
	    $args = array( 
	        ...
	        'query_var' => true,
	        'can_export' => true,
	        'rewrite' => array( 'slug' => __('azp_template','easybook-add-ons') ),
