...
class AZPParser{
    ...
    public function __construct() {
        $this->elementsOptions = easybook_addons_azp_elements();
    }
    ...
    public function getEleDefaultContent($ele){
        $defaultContent = '';
        // $elementsOptions = easybook_addons_azp_elements();
    ...
    protected function loadTemplateNew( $azp_attrs, $azp_content = null ,$azp_element = '') {
        ...
        if(!$shortcodeTemp) $shortcodeTemp = $this->checkShortcodeTemplateNew(strtolower($azp_element));
    ...
    protected function checkShortcodeTemplateNew($file){
    	$template = "{$file}.php";
