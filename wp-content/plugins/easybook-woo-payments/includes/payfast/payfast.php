...
class CTH_Woo_Payments_PayFast extends WC_Payment_Gateway {
    ...
    public function __construct() {
        ...
        $this->order_button_text = __( 'Proceed to PayFast', 'easybook-woo-payments' );
        $this->method_title      = __( 'EasyBook PayFast', 'easybook-woo-payments' );
        /* translators: %s: Link to WC system status page */
        $this->method_description = __( 'This is currently needed for selling RECURRING membership package. It redirects customers to PayFast to enter their payment information.', 'easybook-woo-payments' );
        // $this->supports           = array(
        //     'products',
        //     'refunds',
        // );
        ...
        if ( $this->testmode ) {
            ...
            $this->description .= ' ' . sprintf( __( 'SANDBOX ENABLED. You can use sandbox testing accounts only. See the <a href="%s">PayFast Sandbox Testing Guide</a> for more details.', 'easybook-woo-payments' ), 'https://developers.payfast.co.za/documentation/#testing-and-tools' );
    ...
    public function admin_options() {
        if ( $this->is_valid_for_use() ) {
            ...
            <div class="inline error">
                <p>
                    <strong><?php esc_html_e( 'Gateway disabled', 'easybook-woo-payments' ); ?></strong>: <?php esc_html_e( 'PayFast does not support your store currency.', 'easybook-woo-payments' ); ?>
                </p>
            </div>
            <?php
        }
    ...
    public function get_icon() {
        ...
        $icon_html .= '<img class="cth-woo-payment-icon" src="' . trailingslashit( CTH_WOO_PMS_URL ) . 'assets/images/payfast.png' . '" alt="' . esc_attr__( 'PayFast acceptance mark', 'easybook-woo-payments' ) . '" />';
