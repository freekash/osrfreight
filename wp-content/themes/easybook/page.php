...
<section class="middle-padding grey-blue-bg single-page-section" id="sec1">
    <div class="container">
        <div class="row">
            <?php if( easybook_get_option('blog_layout') ==='left_sidebar' && is_active_sidebar('sidebar-2')):?>
            ...
            <?php endif;?>
            <?php if( easybook_get_option('blog_layout') ==='fullwidth' || !is_active_sidebar('sidebar-2')):?>
            ...
            <?php if( easybook_get_option('blog_layout') === 'right_sidebar' && is_active_sidebar('sidebar-2')):?>
            <div class="col-md-<?php echo esc_attr($sb_w );?> page-sidebar-column">
